...
class Template3 extends Component
{
    ...
    public function mount($investorType,$khmerTrading,$englishTrading,$tradingAccNumber,$investorId,$securityFirm,$contact,$email,$currency,$unitPrice,$quantity,$actualDeposit,$paymentMethod,$refundMethod,$bankName,$bankAccName,$bankAccNumber,$bankAccCurrency)
    {
    ...
    public function render()
    {
        ...
        $view = view('livewire.components.subscription.preview.template3', compact('data'));
