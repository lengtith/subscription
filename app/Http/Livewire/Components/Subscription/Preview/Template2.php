...
class Template2 extends Component
{
    ...
    public function mount($investorType,$khmerTrading,$englishTrading,$tradingAccNumber,$investorId,$securityFirm,$contact,$email,$currency,$unitPrice,$quantity,$actualDeposit,$paymentMethod,$refundMethod,$chequeNumber)
    {
    ...
    public function render()
    {
        ...
        $view = view('livewire.components.subscription.preview.template2', compact('data'));
