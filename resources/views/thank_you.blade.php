...
<div id="main-wrapper" class="mt-5">
    <div class="row justify-content-center">
            <div class="card border-0 text-center" style="width:600px">
                <img class="card-img-top m-auto" style="width: 400px" src="https://img.freepik.com/premium-vector/trading-platform-isolated-cartoon-vector-illustrations_107173-22012.jpg" alt="Card image">
                <div class="card-body">
                    <h3 class="card-title text-center">Thanks for submitting!</h3>
