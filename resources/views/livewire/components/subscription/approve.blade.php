            ...
            <div class="card p-0">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="khmerTradingName" wire:model="khmer_trading_name"
                            required>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input disabled type="number" class="form-control" id="investorId" wire:model="investor_id" required>
                        <div class="invalid-feedback">
                            @error('investor_id')
                            {{ $message }}
                            @enderror
