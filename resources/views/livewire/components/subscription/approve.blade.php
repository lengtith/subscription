<div class="container mt-5 mb-5">
    ...
    <form class="w-75 m-auto">
                    ...
                    <div class="card-body row d-flex gap-3">
                            ...
                            <div class="form-group col flex-column d-flex gap-1">
                                ...
                                <div class="d-flex">
                                    <div class="form-check form-check-inline">
                                        <input disabled class="form-check-input" type="radio" name="investorType"
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex gap-1">
                                ...
                                <input disabled type="text" class="form-control" wire:model="khmer_trading_name">
                                <span class="text-danger">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex gap-1">
                                ...
                                <input disabled type="text" class="form-control" wire:model="english_trading_name">
                                <span class="text-danger">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex gap-1">
                                ...
                                <input disabled type="number" class="form-control" wire:model="trading_acc_number">
                                <span class="text-danger">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex gap-1">
                                ...
                                <input disabled type="number" class="form-control" wire:model="investor_id">
                                <span class="text-danger">
                                    @error('investor_id')
                                    {{ $message }}
                                    @enderror
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col flex-column d-flex gap-1">
                                ...
                                <input disabled type="text" class="form-control" wire:model="security_firm_name">
                                <span class="text-danger">
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex gap-1">
                                ...
                                <input disabled type="tel" class="form-control" wire:model="contact">
                                <span class="text-danger">
                                    @error('contact')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex gap-1">
                                ...
                                <input disabled type="email" class="form-control" wire:model="email">
                                <span class="text-danger">
                                    @error('email')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group col flex-column d-flex gap-1">
                                ...
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" wire:model="currency" value="KHR">
                                        KHR
                                    </label>
                                    <span>/ រៀល</span>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" wire:model="currency" value="USD">
                                        USD
                                    </label>
                                    <span>/ ដុល្លារ</span>
                                </div>
                                    ...
                                    <div id="bankForm">
                                        <div class="p-4 rounded-1 d-flex flex-column gap-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" wire:model="bank_acc_name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                    ...
                    <div class="card-body row d-flex gap-3">
                        <div class="row justify-content-between text-left ">
                            ...
                            <div class="form-group col flex-column d-flex gap-1">
                                ...
                                <input disabled type="file" class="form-control" wire:model="file">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <button wire:click="handleSubmit" class="btn btn-primary">
            <div wire:loading wire:target="handleSubmit">
                <i class="fas fa-spinner fa-spin"></i>
            </div>
            Submit
        </button>
        <button wire:click="handlePreview" class="btn btn-success">Preview</button>
        <button wire:click="resetForm" class="btn btn-light">Cancel</button>
    </form>
</div>
