<div class="container mt-5 mb-5">
    ...
    {{-- <form class="was-validated">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <input disabled class="form-check-input" type="radio" id="investorType" name="individual"
                        ...
                        <div class="form-check">
                            <input disabled class="form-check-input" type="radio" id="investorType2" name="legalEntity"
                    ...
                    <div class="col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="khmerTradingName"
                    ...
                    <div class="col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="englishTradingName"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input disabled type="number" class="form-control" id="tradingAcc"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input disabled type="number" class="form-control" id="investorId" wire:model="investor_id"
                            required>
                        <div class="invalid-feedback">
                            @error('investor_id')
                            {{ $message }}
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input disabled type="text" class="form-control" id="securityFirm"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input disabled type="text" class="form-control" id="phoneNumber" wire:model="contact" required>
                        <div class="invalid-feedback">
                            @error('contact')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input disabled type="text" class="form-control" id="emailAddress" wire:model="email" required>
                        <div class="invalid-feedback">
                            @error('email')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <input type="file" class="form-control" wire:model="signature_attach">
                    </div>
                </div>
            </div>
            ...
            <div class="card p-0">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="currency" wire:model="currency_type"
                                value="KHR">
                            <label for="currency" class="form-label">KHR</label><br>
                            <label for="currency" class="form-label">ប្រាក់រៀល</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="currency2" wire:model="currency_type"
                                value="USD">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-1">
                            <input type="number" class="form-control" wire:model="total_share" required>
        ...
        <button type="submit" wire:click="handleSubmit" class="btn btn-primary">
        ...
        <div class="card p-0">
            ...
            <div class="card-body row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <label for="englishTradingName" class="form-label">ឈ្មោះគណនីជួញដូរ (អង់គ្លេស)</label>
                    <input disabled type="text" class="form-control" id="englishTradingName"
                        wire:model="english_trading_name">
                    <div class="invalid-feedback">
                        @error('english_trading_name')
                        {{ $message }}
                        @enderror
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <label for="tradingAcc" class="form-label required">Trading Account No.</label><br>
                    <label for="tradingAcc" class="form-label">លេខគណនីជួញដូរ</label>
                    <input disabled type="number" class="form-control" id="tradingAcc" wire:model="trading_acc_number">
                    <div class="invalid-feedback">
                        @error('trading_acc_number')
                        {{ $message }}
                        @enderror
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <label for="securityFirm" class="form-label required">Security Firm</label><br>
                    <label for="securityFirm" class="form-label">ឈ្មោះក្រុមហ៊ុនមូលបត្រ</label>
                    <input disabled type="text" class="form-control" id="securityFirm" wire:model="security_firm_name">
                    <div class="invalid-feedback">
                        @error('security_firm_name')
                        {{ $message }}
                        @enderror
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <label for="phoneNumber" class="form-label required">Phone Number</label><br>
                    <label for="phoneNumber" class="form-label">លេខទូរស័ព្ទ</label>
                    <input disabled type="text" class="form-control" id="phoneNumber" wire:model="contact">
                    <div class="invalid-feedback">
                        @error('contact')
                        {{ $message }}
                        @enderror
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <label for="emailAddress" class="form-label required">Email Address</label><br>
                    <label for="emailAddress" class="form-label">អ៊ីម៉ែល</label>
                    <input disabled type="text" class="form-control" id="emailAddress" wire:model="email">
                    <div class="invalid-feedback">
                        @error('email')
                        {{ $message }}
                        @enderror
        ...
        <form>
            <div class="row g-3">
                ...
                <div class="card p-0">
                    ...
                    <div class="card-body row g-3">
                        <div class="col-md-12">
                            <label class="form-label required">Currency Type <span> / ប្រភេទរូបិបណ្ណ</span></label>

                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="currency" wire:model="currency_type"
                                    value="KHR">
                                <label for="currency" class="form-label">KHR
                                    <span> / ប្រាក់រៀល</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="currency2" wire:model="currency_type"
                                    value="USD">
                                <label for="currency2" class="form-label">USD
                        ...
                        <div class="col-md-6">
                            <label class="form-label required">Total number of Offer Shares for
                                subscription
                                <br>
                            ...
                            <div class="input-group mb-1">
                                <input type="number"
                                    class="form-control @if($errors->has('total_share')) is-invalid @elseif ($total_share == null) @else is-valid @endif"
                                    wire:model="total_share" required>
                                <span class="input-group-text">ហ៊ុន</span>
                            </div>
                            <div class="text-danger">
                                @error('total_share')
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($currency_type == 'KHR')
                            <div class="input-group mb-3">
                                <label class="form-control"> {{ $company == '' ? 0 : $company->khr_price * $total_share
                                    }}
                                </label>
                                <span class="input-group-text">KHR</span>
                            </div>
                            @else
                            <div class="input-group mb-3">
                                <label class="form-control"> {{ $company == '' ? 0 : $company->usd_price * $total_share
                                    }}
                                </label>
                                <span class="input-group-text">USD</span>
                            </div>
                        ...
                        <div class="col-md-6">
                            <label for="unit-price" class="form-label required">Actual deposit for subscription
                                <br>
                            ...
                            <div class="input-group mb-1">
                                <input type="number"
                                    class="form-control @if($errors->has('actual_deposit')) is-invalid @elseif ($actual_deposit == null) @else is-valid @endif"
                                    wire:model="actual_deposit" required>
                                <span class="input-group-text">KHR</span>
                            </div>
                            <div class="text-danger">
                                @error('actual_deposit')
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label required">Choose your payment options
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" value="{{ $method->id }}"
                                        wire:model="payment_method" id="{{ $method->name }}">
                                    <label class="form-check-label" for="{{ $method->name }}">{{ $method->name
                                        }}<span> ({{ $method->description }})</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label required">Attachment file
                                <span> / ឯកសារភ្ជាប់</span>
                            </label>

                            <input type="file"
                                class="form-control @if($errors->has('payment_attach')) is-invalid @elseif ($payment_attach == null) @else is-valid @endif"
                                wire:model="payment_attach" required>
                            <div class="invalid-feedback">
                                @error('payment_attach')
                                {{ $message }}
                                @enderror
                ...
                <div class="card p-0">
                    ...
                    <div class="card-body row g-3">
                        <div class="col-md-12">
                            <label class="form-label required">Choose your refund options
        ...
        <table class="table table-bordered mb-2">
            ...
            <tr>
                ...
                <td colspan="2">
                    <p class="font-sm">
                        @if ($currency_type == 'USD')
                        {{ '$' .$company->usd_price*$total_share }}
                        @else
                        {{ $company->khr_price*$total_share.' រៀល' }}
                        @endif
