            ...
            <div class="card p-0">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                            class="form-control @if($errors->has('khmer_trading_name')) is-invalid @elseif ($khmer_trading_name == null) @else is-valid @endif"
                            id="khmerTradingName" wire:model="khmer_trading_name" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                            class="form-control @if($errors->has('english_trading_name')) is-invalid @elseif ($english_trading_name == null) @else is-valid @endif"
                            id="englishTradingName" wire:model="english_trading_name" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="number"
                            class="form-control @if($errors->has('trading_acc_number')) is-invalid @elseif ($trading_acc_number == null) @else is-valid @endif"
                            id="tradingAcc" wire:model="trading_acc_number" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="number"
                            class="form-control @if($errors->has('investor_id')) is-invalid @elseif ($investor_id == null) @else is-valid @endif"
                            id="investorId" wire:model="investor_id" required>
                        <div class="invalid-feedback">
                            @error('investor_id')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text"
                            class="form-control @if($errors->has('security_firm_name')) is-invalid @elseif ($security_firm_name == null) @else is-valid @endif"
                            id="securityFirm" wire:model="security_firm_name" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text"
                            class="form-control @if($errors->has('contact')) is-invalid @elseif ($contact == null) @else is-valid @endif"
                            id="phoneNumber" wire:model="contact" required>
                        <div class="invalid-feedback">
                            @error('contact')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text"
                            class="form-control @if($errors->has('email')) is-invalid @elseif ($email == null) @else is-valid @endif"
                            id="emailAddress" wire:model="email" required>
                        <div class="invalid-feedback">
                            @error('email')
                            {{ $message }}
                            @enderror
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-1">
                            <input type="number" class="form-control @if($errors->has('total_share')) is-invalid @elseif ($total_share == null) @else is-valid @endif" wire:model="total_share" required>
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($currency_type == 'KHR')
                        <div class="input-group mb-1">
                            <input type="number" class="form-control @if($errors->has('actual_deposit')) is-invalid @elseif ($actual_deposit == null) @else is-valid @endif" wire:model="actual_deposit" required>
                            <span class="input-group-text">KHR</span>
                        </div>
                        <div class="text-danger">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" class="form-control @if($errors->has('payment_attach')) is-invalid @elseif ($payment_attach == null) @else is-valid @endif" wire:model="payment_attach" required>
                        <div class="invalid-feedback">
